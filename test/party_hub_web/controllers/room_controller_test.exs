defmodule PartyHubWeb.RoomControllerTest do
  use PartyHubWeb.ConnCase

  alias PartyHub.Parties

  @create_attrs %{name: "some name", twilio_room_id: "some twilio_room_id"}
  @update_attrs %{name: "some updated name", twilio_room_id: "some updated twilio_room_id"}
  @invalid_attrs %{name: nil, twilio_room_id: nil}

  def fixture(:room) do
    {:ok, room} = Parties.create_room(@create_attrs)
    room
  end
